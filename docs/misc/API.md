...
- [TextureSelection](../api/classes/textureselection.md)
- [CanvasTexture](../api/classes/canvastexture.md), [canvas()](../api/globals.md#canvas)

#### Pointer Events

- [PointerSyntheticEvent](../api/classes/pointersyntheticevent.md)
- [EventPoint](../api/classes/eventpoint.md)

- [POINTER_CANCEL](../api/globals.md#const-pointer_cancel), [POINTER_CLICK](../api/globals.md#const-pointer_click), [POINTER_END](../api/globals.md#const-pointer_end), [POINTER_MOVE](../api/globals.md#const-pointer_move), [POINTER_START](../api/globals.md#const-pointer_start)
