(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined" ? module.exports = factory() : typeof define === "function" && define.amd ? define(factory) : (global = typeof globalThis !== "undefined" ? globalThis : global || self, global.Stage = factory());
})(this, function() {
  "use strict";
  ...
  function insertBefore(self2, next) {
    _ensure(self2);
    _ensure(next);
    self2.remove();
    ...
    self2._ts_parent = ++iid$1;
    self2.touch();
  }
  function insertAfter(self2, prev) {
    _ensure(self2);
    _ensure(prev);
    self2.remove();
  ...
  function Root(request, render) {
    ...
    var loop = function(now) {
      ...
      lastTime = now;
      var ticked = self2._tick(elapsed, now, last);
      if (self2._mo_touch != self2._ts_touch) {
        self2._mo_touch = self2._ts_touch;
        render(self2);
        request(loop);
      } else if (ticked) {
        request(loop);
  ...
  Image$1.prototype._repeat = function(stretch, inner) {
    ...
    function insert(i, sx, sy, sw, sh, dx, dy, dw, dh) {
      var repeat2 = self2._textures.length > i ? self2._textures[i] : self2._textures[i] = self2._image.pipe();
