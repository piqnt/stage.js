...
Cut.atlas = function(def) {
  ...
  var url = def.image && def.image.url || def.imagePath || def.imageUrl;
  var ratio = def.image && def.image.ratio || def.imageRatio || 1;
